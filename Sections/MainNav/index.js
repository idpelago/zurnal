                ...
                <ul className="nav navbar-nav">
                  ...
                  <li className="nav-item dropdown utf_mega_dropdown">
                    <a
                      ...
                      aria-expanded="false"
                    >
                      Lifestyle <i className="fa fa-angle-down"></i>
                    </a>
                                ...
                                <div className="col-md-3">
                                  <div className="utf_post_block_style clearfix">
                                    ...
                                    <div className="utf_post_content">
                                      <h2 className="utf_post_title title-small">
                                        <a href="#">
                                          Deleting fears from the brain means
                                          you might neve…
                                        </a>
                                      </h2>
                                    </div>
                                ...
                                <div className="col-md-3">
                                  <div className="utf_post_block_style clearfix">
                                    ...
                                    <div className="utf_post_content">
                                      <h2 className="utf_post_title title-small">
                                        <a href="#">
                                          Smart packs parking sensor tech and
                                          beeps when col…
                                        </a>
                                      </h2>
                                    </div>
                  ...
                  <li className="dropdown nav-item utf_mega_dropdown">
                    <a
                      href="#"
                      className="nav-link dropdown-toggler"
                      data-toggle="dropdown"
                    >
                      Video <i className="fa fa-angle-down"></i>
                    </a>
                    <div className="utf_dropdown_menu utf_mega_menu_content clearfix">
                      <div className="utf_mega_menu_content_inner">
                        <div className="row">
                          <div className="col-md-3">
                            <div className="utf_post_block_style clearfix">
                              <div className="utf_post_thumb">
                          ...
                          <div className="col-md-3">
                            <div className="utf_post_block_style clearfix">
                              ...
                              <div className="utf_post_content">
                                <h2 className="utf_post_title title-small">
                                  <a href="#">
                                    TG G6 will have dual 13-megapixel cameras...
                                  </a>
                                </h2>
                              </div>
                            </div>
                  ...
                  <li className="dropdown">
                    ...
                    <ul className="utf_dropdown_menu" role="menu">
                      <li className="utf_dropdown_submenu">
                        <a href="#.">
                          <i className="fa fa-angle-double-right"></i> Category
                          Layouts
                        </a>
                        <ul className="utf_dropdown_menu">
                          <li>
                      ...
                      <li className="utf_dropdown_submenu">
                        <a href="#.">
                          <i className="fa fa-angle-double-right"></i> Post
                          Detail Page
                        </a>
                        <ul className="utf_dropdown_menu">
                          <li>
                          ...
                          <li>
                            <a href="left-sidebar.html">
                              <i className="fa fa-angle-double-right"></i> Left
                              Sidebar
                            </a>
                          </li>
                          <li>
                            <a href="right-sidebar.html">
                              <i className="fa fa-angle-double-right"></i> Right
                              Sidebar
                            </a>
                          </li>
                          <li>
                            <a href="no-sidebar.html">
                              <i className="fa fa-angle-double-right"></i> No
                              Sidebar
                            </a>
                          </li>
                        </ul>
                      ...
                      <li className="utf_dropdown_submenu">
                        <a href="#.">
                          <i className="fa fa-angle-double-right"></i> Pages
                        </a>
                        <ul className="utf_dropdown_menu">
                          <li>
                            <a href="contact.html">
